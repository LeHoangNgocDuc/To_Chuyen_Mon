        ...
        <div className="fixed inset-0 bg-slate-900/80 backdrop-blur-md flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-[3.5rem] shadow-2xl max-w-lg w-full p-10 animate-in zoom-in duration-300">
            ...
            <div className="mt-8 flex gap-4">
              <button onClick={() => setShowAdjustModal(false)} className="flex-1 font-black text-slate-400 uppercase tracking-widest">Đóng</button>
